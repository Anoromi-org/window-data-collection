...
impl GenericActiveWindowManager
{
  ...
  pub fn new() -> Result< Self >
  {
    #[ cfg( feature = "win" ) ]
    {
      ...
      return Ok( Self { inner : Box::new( WindowsWindowManager::new() ) } );
    }
    #[ cfg( feature = "macos" ) ]
    {
    ...
    #[ cfg( feature = "x11" ) ]
    {
      ...
      let _ = try_create_manager!( X11WindowManager::new() )
      .inspect_err( | e | tracing::error!( "Failed creating X11 manager {e:?}" ) );
    }
    #[ cfg( feature = "kde_wlnd" ) ]
    {
    ...
    Err( anyhow!( "No window was found matching" ) )
  }
}
